            ...
            child: Material(
              ...
              child: CustomScrollView(
                ...
                slivers: [
                  ...
                  // Metrics row
                  if (routePoints.isNotEmpty && distanceM != null && durationS != null)
                    SliverToBoxAdapter(
                      child: Padding(
                          ...
                          children: [
                            Expanded(
                              child: _MetricCard(
                                ...
                                label: 'Distance',
                                value: '${(distanceM! / 1000).toStringAsFixed(2)} km',
                            ...
                            Expanded(
                              child: _MetricCard(
                                icon: Icons.schedule,
                                label: 'Duration',
                                value: '${Duration(seconds: durationS!.toInt()).inMinutes} min',
                                colorScheme: colorScheme,
                              ),
                            ),
                          ],
                    ...
                    child: Column(
                      ...
                      children: [
                        FilledButton.icon(
                          ...
                          label: computing ? const Text('Computing Route…') : const Text('Start Navigation'),
                          ...
                          onPressed: routePoints.isEmpty || computing
                              ...
                              : () {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    const SnackBar(
                                      content: Text('Device communication not yet implemented'),
                                    ),
                                  );
                                },
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              if (computeError != null || (routePoints.isEmpty && !computing))
                                IconButton(
